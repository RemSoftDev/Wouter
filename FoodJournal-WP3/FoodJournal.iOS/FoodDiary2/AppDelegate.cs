...
using FoodDiary2.iOS.Controller;
...
//			Window.RootViewController = new UINavigationController (AppDelegate.Storyboard.InstantiateViewController ("FDSettingsVC")); 
			Window.MakeKeyAndVisible();
			Navigate.nsobject = this;
