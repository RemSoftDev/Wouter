...
namespace FoodJournal.WinPhone.Common.AppModel.Data.Serialization
{
    ...
    // Full graph
    // <Date Key="8/14/2015">
    //    <Period Key="Breakfast" Time="10am">
    //      <Entry Key="Bread" Amount="1 slice" Properties="asdasdasdasdasdasd" />
    //      <Entry Key="Tea" Amount="1 cup" Properties="asdasdasdasdasdasd" />
    //      <Note Key="Note">Excellent breakfast this time!</Note>
    //    </Period>
    // </Date>
    ...
    public class Serializer
    {
        ...
        public void Read(string Field, ref DateTime value) { if (values.ContainsKey(Field)) value = DateTime.Parse(values[Field]); } // TODO: convert, and conversion errors
        public void Read(string Field, ref Single value) { if (values.ContainsKey(Field)) value = Single.Parse(values[Field]); } // TODO: convert, and conversion errors
        ...
        //public Serializer Add(Serializer child) { contents.Add(child); return child; }
